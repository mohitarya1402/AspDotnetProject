...
namespace AspDotnetProject.Controllers
{
    public class registrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "person_id,FirstName,LastName,nic,course_id,batch_id,Contact")] registration registration)
        {
            ...
            ViewBag.course_id = new SelectList(db.courses, "course_id", "course1", registration.course_id);
            return View(registration);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "person_id,FirstName,LastName,nic,course_id,batch_id,Contact")] registration registration)
        {
            if (ModelState.IsValid)
            {
